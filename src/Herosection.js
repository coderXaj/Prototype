...
function Herosection() {
    return (
        <>
            ...
            <div className='customersocial'>
                <h1>Be where your customers are</h1>
                <p>People spend, on average, almost 2.5 hours on social media every day. ​​Let them find your brand more easily
                    <br />through these four simple steps:</p>
                <div><img src='./img5.png' alt='pic' /></div>
            </div>
            <div className='main3'>
